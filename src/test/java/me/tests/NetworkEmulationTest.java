	...
	public static void initDriverAndDevTools() {
	 ...
	 @Test
	    public static void enableNetworkOffline() {
		 ...
		 chromeDevTools.send(emulateNetworkConditions(true, 100, 1000, 2000,
	                Optional.of(ConnectionType.cellular3g)));
		 chromeDevTools.addListener(Log.entryAdded(), entry ->  System.out.println("Error is ====================="+entry.getText()));
		 chromeDevTools.addListener(Log.entryAdded(), entry ->  assertEquals(entry.getText(), "net::ERR_INTERNET_DISCONNECTED"));
